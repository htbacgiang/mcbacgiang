                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     ...
                     <tr>
                      <td align="center" class="es-m-p0r es-m-p0l" style="Margin:0;padding-top:5px;padding-right:40px;padding-bottom:5px;padding-left:40px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"><strong>Chào mừng bạn đến với Q&K Bắc Giang!</strong></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Cảm ơn bạn đã đăng ký tài khoản tại Q&K Bắc Giang. Để hoàn tất quá trình đăng ký và kích hoạt tài khoản, vui lòng xác minh địa chỉ email của bạn bằng cách nhấn vào nút bên dưới:</p></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><span class="es-button-border" style="border-style:solid;border-color:#ec4899;background:linear-gradient(135deg,#ec4899 0%,#f43f5e 100%);border-width:0px;display:inline-block;border-radius:6px;width:auto"><a href="${url}" target="_blank" class="es-button" style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;padding:10px 30px 10px 30px;display:inline-block;background:linear-gradient(135deg,#ec4899 0%,#f43f5e 100%);border-radius:6px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:21.6px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #ec4899;padding-left:30px;padding-right:30px">XÁC MINH ĐỊA CHỈ EMAIL</a></span></td>
                     </tr>
                     <tr>
                      <td align="center" class="es-m-p0r es-m-p0l" style="Margin:0;padding-top:5px;padding-right:40px;padding-bottom:5px;padding-left:40px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:left"><strong>Lưu ý:</strong> Mã xác minh này chỉ có giá trị trong vòng <strong>48 giờ</strong> kể từ khi email được gửi. Sau thời gian này, bạn sẽ cần yêu cầu một mã mới nếu chưa kịp xác minh. Chúc bạn có những trải nghiệm tuyệt vời cùng Q&K Bắc Giang!</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:left"><br>Nếu có bất kỳ thắc mắc nào, vui lòng liên hệ với chúng tôi qua&nbsp;</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:left">Email: <a href="mailto:lienhe@mcbacgiang.com" style="mso-line-height-rule:exactly;text-decoration:underline;color:#ec4899;font-size:14px">lienhe@mcbacgiang.com</a> hoặc hotline: 081.6997.000</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:left">Trân trọng,<br><strong>Đội ngũ <a target="_blank" href="https://mcbacgiang.com" style="mso-line-height-rule:exactly;text-decoration:underline;color:#ec4899;font-size:14px;text-align:left">Q&K Bắc Giang</a></strong></p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
