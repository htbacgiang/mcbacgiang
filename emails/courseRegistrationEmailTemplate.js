...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="vi">
 <head>
  ...
  <title>Đăng ký khóa học thành công - MC Q&K Bắc Giang</title>
  <style type="text/css">
                   ...
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:10px;font-size:0px">
                        <div style="display:flex;align-items:center;justify-content:center;margin-bottom:20px;">
                          <div style="width:60px;height:60px;background:linear-gradient(135deg,#ec4899 0%,#f43f5e 100%);border-radius:15px;display:flex;align-items:center;justify-content:center;margin-right:15px;">
                            <span style="color:white;font-weight:bold;font-size:24px;font-family:arial,sans-serif;">Q&K</span>
                          </div>
                          <span style="font-size:32px;font-weight:bold;color:#1f2937;font-family:arial,sans-serif;">Bắc Giang</span>
                        </div>
                      </td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                      <td align="center" class="es-m-p0r es-m-p0l" style="Margin:0;padding-top:5px;padding-right:40px;padding-bottom:20px;padding-left:40px">
                        ...
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                          Cảm ơn bạn đã đăng ký khóa học tại <strong>MC Q&K Bắc Giang</strong>! Chúng tôi đã nhận được thông tin đăng ký của bạn và sẽ liên hệ với bạn trong thời gian sớm nhất.
                        </p>
                        ${courseName ? `<p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                          <strong>Khóa học đã đăng ký:</strong> ${courseName}
                        </p>` : ''}
                      </td>
                     </tr>
                     <tr>
                      <td align="center" class="es-m-p0r es-m-p0l" style="Margin:0;padding-top:5px;padding-right:40px;padding-bottom:20px;padding-left:40px">
                        ...
                        <ul style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:left">
                          <li>📞 Đội ngũ tư vấn sẽ liên hệ với bạn trong vòng 24h</li>
                          <li>💬 Tư vấn chi tiết về khóa học và lịch học phù hợp</li>
                          <li>📝 Hướng dẫn thủ tục đăng ký và thanh toán</li>
                          <li>🎓 Bắt đầu hành trình học tập tại MC Q&K Bắc Giang</li>
                        </ul>
                      </td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:20px;padding-bottom:20px">
                        <span class="es-button-border" style="border-style:solid;border-color:#ec4899;background:linear-gradient(135deg,#ec4899 0%,#f43f5e 100%);border-width:0px;display:inline-block;border-radius:6px;width:auto">
                          <a href="${courseLink}" target="_blank" class="es-button" style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;padding:10px 30px 10px 30px;display:inline-block;background:linear-gradient(135deg,#ec4899 0%,#f43f5e 100%);border-radius:6px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:21.6px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;padding-left:30px;padding-right:30px">
                     ...
                     <tr>
                      <td align="center" class="es-m-p0r es-m-p0l" style="Margin:0;padding-top:5px;padding-right:40px;padding-bottom:20px;padding-left:40px">
                        ...
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                          📧 Email: <a href="mailto:lienhe@mcbacgiang.com" style="mso-line-height-rule:exactly;text-decoration:underline;color:#ec4899;font-size:14px">lienhe@mcbacgiang.com</a>
                        </p>
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                          📞 Hotline: <a href="tel:0816997000" style="mso-line-height-rule:exactly;text-decoration:underline;color:#ec4899;font-size:14px">081.6997.000</a>
                        </p>
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                          🏢 Địa chỉ: Số 1 Nguyễn Văn Linh, phường Bắc Giang, tỉnh Bắc Ninh
                        </p>
                      </td>
                     </tr>
                     <tr>
                      <td align="center" class="es-m-p0r es-m-p0l" style="Margin:0;padding-top:20px;padding-right:40px;padding-bottom:5px;padding-left:40px">
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                          Trân trọng,<br>
                          <strong>Đội ngũ <a target="_blank" href="https://mcbacgiang.com" style="mso-line-height-rule:exactly;text-decoration:underline;color:#ec4899;font-size:14px">MC Q&K Bắc Giang</a></strong>
                        </p>
                      </td>
                     </tr>
                   </table>
                     ...
                     <tr>
                      <td align="center" class="es-infoblock" style="padding:0;Margin:0">
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#CCCCCC;font-size:12px">
                          © 2024 MC Q&K Bắc Giang. Trung tâm đào tạo MC chuyên nghiệp.
                        </p>
                      </td>
                     </tr>
                   </table>
